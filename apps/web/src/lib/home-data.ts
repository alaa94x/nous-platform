const SEED_SETTINGS: Record<string, string> = {
  ...
  hero_cta_primary_en: 'Bring Us Your Problem',
  hero_cta_primary_ar: 'اعرض علينا مشكلتك',
  hero_cta_secondary_en: 'WhatsApp',
  hero_cta_secondary_ar: 'واتساب',
  ...
  contact_title_en: 'Tell us what you need.',
  contact_title_ar: 'أخبرنا بما تحتاجه.',
  ...
  contact_cta_en: 'Contact us',
  contact_cta_ar: 'تواصل معنا',
