...
const SECTIONS: Section[] = [
  {
    ...
    fields: [
      ...
      { key: 'hero_cta_primary_en', label: 'Primary CTA (EN)', hint: 'Keep it direct and inclusive', placeholder: 'Bring Us Your Problem', maxChars: 36 },
      { key: 'hero_cta_primary_ar', label: 'Primary CTA (AR)', placeholder: 'اعرض علينا مشكلتك', maxChars: 36, rtl: true },
      { key: 'hero_cta_secondary_en', label: 'WhatsApp CTA (EN)', hint: 'The icon already identifies the channel—use a short label', placeholder: 'WhatsApp', maxChars: 20 },
      { key: 'hero_cta_secondary_ar', label: 'WhatsApp CTA (AR)', hint: 'استخدم تسمية قصيرة وواضحة', placeholder: 'واتساب', maxChars: 20, rtl: true },
  ...
  },
  {
    ...
    fields: [
      { key: 'contact_title_en', label: 'Title (EN)', placeholder: 'Tell us what you need.', maxChars: 72 },
      { key: 'contact_title_ar', label: 'Title (AR)', placeholder: 'أخبرنا بما تحتاجه.', maxChars: 72, rtl: true },
      ...
      { key: 'contact_cta_en', label: 'CTA (EN)', placeholder: 'Contact us', maxChars: 38 },
      { key: 'contact_cta_ar', label: 'CTA (AR)', placeholder: 'تواصل معنا', maxChars: 38, rtl: true },
